            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('services' . '/' . $service->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $service->name }} </td></tr><tr><th> Distance </th><td> {{ $service->distance }} </td></tr><tr><th> Cost </th><td> {{ $service->cost }} </td></tr><tr><th> Remake </th><td> {{ $service->remake }} </td></tr><tr><th> Car Id </th><td> {{ $service->car_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
