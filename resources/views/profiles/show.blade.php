                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Name </th><td> {{ $profile->name }} </td></tr><tr><th> Lastname </th><td> {{ $profile->lastname }} </td></tr><tr><th> Card Number </th><td> {{ $profile->card_number }} </td></tr><tr><th> Address </th><td> {{ $profile->address }} </td></tr><tr><th> Contact </th><td> {{ $profile->contact }} </td></tr><tr><th> User Id </th><td> {{ $profile->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
